...
public class Parcel extends Item{
	...
	public Parcel(int id, String name, String description, String ean, int supplierId, int categoryId,
			StatusType status) {
		super(id, name, description, ean, supplierId, categoryId, status);
		// TODO Auto-generated constructor stub
	}

	public Parcel(int id, String name, String description, String ean, int supplierId, Supplier supplier,
